  ...
  return (
    <section className="py-12" id="">
      <div className="container mx-auto px-4">
        <div className="flex items-baselines justify-between mb-8">
         <div className="text-2xl md:text-3xl font-bold text-white">
          ...
          <div className="flex space-x-2">
            ...
            <button className="p-2 rounded-full bg-neutral-700  text-white transition-all" aria-label="Scroll Right">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-1">
                        <svg
                          ...
                          fill="currentColor"
                        >
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.682 8.027c-.783-.57-1.371-1.24.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
